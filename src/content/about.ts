...
/**
 * ベントのセルに置く図（§6.11.2、DECISION U-40）。実体は icons.tsx の bentoIcons が解決する。
...
export const aboutContent = {
  ...
  /** 公認と公式パートナーを 1 セルに集約し、各行を図 + 題 + 補足で並べる（DECISION U-14 → U-40） */
  official: {
    kicker: "OFFICIAL",
    rows: [
      {
